 ...
 * JavaScript functions can also be invoked with the new operator. TypeScript refers to
 * these as constructors because they usually create a new object. You can write a construct
...
function fn(s: string, actor: SomeConstructor) {
  return new actor(s);
}
